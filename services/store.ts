...
const MOCK_PROMOTIONS: Promotion[] = [
  { id: 'promo1', name: 'DESCUENTO RON CARTAVIO', type: 'PERCENTAGE_DISCOUNT', value: 10, product_ids: ['p2'], start_date: '2024-01-01', end_date: '2024-12-31', is_active: true },
];
  ...
  createOrder: (order) => set(s => {
     ...
     const processedItems: OrderItem[] = order.items.map(item => {
        ...
        for (const b of availableBatches) {
           ...
           // We update the batch copy 'newBatches' which will replace the state
