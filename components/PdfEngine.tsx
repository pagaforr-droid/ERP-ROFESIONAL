...
export const PdfEngine = {
     ...
     */
    generateDocumentUrl: async (data: any, type: 'FACTURA' | 'BOLETA' | 'GUIA' | 'GUIA_CONSOLIDADA', companyInfo: any): Promise<string> => {
        try {
     ...
     */
    openDocument: async (data: any, type: 'FACTURA' | 'BOLETA' | 'GUIA' | 'GUIA_CONSOLIDADA', companyInfo: any) => {
