...
export const PdfEngine = {
     ...
     */
    generateDocumentUrl: async (data: any, type: 'FACTURA' | 'BOLETA' | 'GUIA' | 'GUIA_CONSOLIDADA' | 'NOTA DE CREDITO' | 'NOTA_CREDITO' | 'BATCH' | 'BOLETA_PAGO' | 'TRASLADO', companyInfo: any): Promise<string> => {
        try {
     ...
     */
    openDocument: async (data: any, type: 'FACTURA' | 'BOLETA' | 'GUIA' | 'GUIA_CONSOLIDADA' | 'NOTA DE CREDITO' | 'NOTA_CREDITO' | 'BATCH' | 'BOLETA_PAGO' | 'TRASLADO', companyInfo: any) => {
